  ...
  <div class="login-container">
    <el-form class="login-form" autoComplete="on" label-position="left" ref="loginForm" :rules="rules"
      ...
      <el-form-item prop="password">
        ...
        <span class="svg-container show-pwd" @click="changeType">
          <v-icon :name="pwdType==`password`?`eye-off`:`eye`"/>
        </span>
      </el-form-item>
      <el-form-item>
      ...
      <el-form-item>
        <el-button type="default" style="width:100%;" @click="submitForm('register')">注册  register</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
